...
interface BlogPostClientProps {
  preloadedBlog: any; // Preloaded-objektet från servern
}

export default function BlogPostClient({ preloadedBlog }: BlogPostClientProps) {
  // KORREKT: usePreloadedQuery tar ENDAST preloaded-objektet som argument
  // INTE query-funktionen och preloaded-objektet
